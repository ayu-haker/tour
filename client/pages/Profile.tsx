...
export default function Profile() {
  ...
  const [reviews, setReviews] = useState(() => loadJSON<any[]>(REV_KEY, []));
              ...
              <CardContent className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2 sm:col-span-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button
                      onClick={() => persistProfile({ ...prof, avatar: null })}
                      variant="destructive"
                    >
                      Remove
                    </Button>
              ...
              <CardContent className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <select
                    value={prof.theme}
                    onChange={(e) =>
                      persistProfile({ ...prof, theme: e.target.value as any })
                    }
